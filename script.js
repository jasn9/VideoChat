...
function startWebRTC(isOfferer) {
    ...
    room.on("data", (message, client) => {
        ...
        // sdp == session description protocol on mozilla
        if (message.sdp) {
            let closeBtn = document.querySelector('#closeConnection');
            closeBtn.style.display = 'block';
            let progressBlock = document.querySelector('.progress-block');
            progressBlock.style.display = 'none';
            // This is called after receiving an offer or answer from another peer for storing second user ino
